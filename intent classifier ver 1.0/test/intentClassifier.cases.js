...
const standardCases = [
  ...
  ,
  { name: "cantonese package count", input: "我想問個package仲有幾多次", primaryIntent: "package_status", minConfidence: 0.9 },
  { name: "cantonese package expiry", input: "我個facial套票幾時到期？", primaryIntent: "package_status", minConfidence: 0.9 },
  { name: "english package balance", input: "How many sessions are remaining in my package?", primaryIntent: "package_status", language: "en", minConfidence: 0.9 },
  { name: "mixed package expiry", input: "package expiry date係幾時？", primaryIntent: "package_status", language: "mixed", minConfidence: 0.9 },
  { name: "cantonese package extension complaint", input: "個package可唔可以延期？你之前話可以", primaryIntent: "complaint", secondaryIntents: ["pricing"], needsHumanReview: true, minConfidence: 0.9 },
  { name: "bazi pricing", input: "八字詳細批幾錢？", primaryIntent: "pricing", secondaryIntents: ["service_info"], minConfidence: 0.9 },
  { name: "bazi opening hours", input: "你哋幾點開舖？係咪24小時？", primaryIntent: "hours_location", minConfidence: 0.86 },
  { name: "bazi intake info", input: "批八字需要咩資料？", primaryIntent: "service_info", minConfidence: 0.74 },
  { name: "bazi health sensitive", input: "可以睇壽命同健康病痛嗎？", primaryIntent: "sensitive_health", needsHumanReview: true, minConfidence: 0.89 },
  { name: "bazi payment methods", input: "可以用FPS PayMe Alipay付款嗎？", primaryIntent: "payment", language: "mixed", minConfidence: 0.8 },
  { name: "bazi delivery format", input: "詳細批付款後幾時有？可唔可以語音或通話？", primaryIntent: "service_info", secondaryIntents: ["payment"], minConfidence: 0.88 },
  { name: "bazi legal topic", input: "可唔可以問法律官司？", primaryIntent: "service_info", minConfidence: 0.74 },
  { name: "bazi stacked payment pricing", input: "我想知點收錢同幾多錢", primaryIntent: "pricing", secondaryIntents: ["payment"], minConfidence: 0.9 },
  { name: "bazi stacked payment scope", input: "點收錢同有咩可以問", primaryIntent: "payment", secondaryIntents: ["service_info"], minConfidence: 0.8 },
  ...
  {"name":"cantonese shop name","input":"你地間舖叫咩","primaryIntent":"hours_location","minConfidence":0.86},
  ...
  {"name":"mixed treatment list","input":"有冇list","primaryIntent":"service_info","language":"mixed","minConfidence":0.74},
  {"name":"cantonese treatment list","input":"有咩療程？","primaryIntent":"service_info","minConfidence":0.74},
  {"name":"cantonese recommendation","input":"推介呢？","primaryIntent":"service_info","minConfidence":0.74},
  {"name":"english treatment list","input":"What treatments do you have?","primaryIntent":"service_info","language":"en","minConfidence":0.74},
