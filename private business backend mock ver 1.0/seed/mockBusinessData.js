...
module.exports = {
  beauty_demo: {
    ...
    availability: [
      ...
      // Fresh test data — next ~7 days from 2026-05-23
      { date: "2026-05-23", time: "13:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-23", time: "15:30", service: "facial", available: false, staff: null },
      { date: "2026-05-23", time: "18:00", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-23", time: "19:30", service: "laser", available: true, staff: "Joey" },
      { date: "2026-05-24", time: "11:30", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-24", time: "14:00", service: "assessment", available: true, staff: "Amy" },
      { date: "2026-05-24", time: "16:00", service: "facial", available: false, staff: null },
      { date: "2026-05-25", time: "12:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-25", time: "14:30", service: "laser", available: true, staff: "Joey" },
      { date: "2026-05-25", time: "19:00", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-25", time: "20:30", service: "facial", available: false, staff: null },
      { date: "2026-05-26", time: "13:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-26", time: "18:00", service: "facial", available: false, staff: null },
      { date: "2026-05-26", time: "19:30", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-27", time: "14:00", service: "assessment", available: true, staff: "Amy" },
      { date: "2026-05-27", time: "17:30", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-27", time: "20:00", service: "laser", available: true, staff: "Joey" },
      { date: "2026-05-28", time: "11:30", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-28", time: "15:00", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-28", time: "18:30", service: "facial", available: false, staff: null },
      { date: "2026-05-28", time: "20:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-29", time: "13:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-29", time: "17:00", service: "laser", available: true, staff: "Joey" },
      { date: "2026-05-29", time: "19:30", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-30", time: "12:00", service: "facial", available: true, staff: "Amy" },
      { date: "2026-05-30", time: "14:30", service: "facial", available: false, staff: null },
      { date: "2026-05-30", time: "18:00", service: "facial", available: true, staff: "Joey" },
      { date: "2026-05-30", time: "19:30", service: "assessment", available: true, staff: "Amy" }
    ],
    bookings: [
  ...
  restaurant_demo: {
    ...
    availability: [
      ...
      // Fresh test data — next ~7 days from 2026-05-23
      { date: "2026-05-23", time: "18:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-23", time: "19:30", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-23", time: "20:30", partySize: 2, available: true, table: "T3" },
      { date: "2026-05-23", time: "21:00", partySize: 6, available: false, table: null },
      { date: "2026-05-24", time: "12:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-24", time: "13:30", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-24", time: "18:30", partySize: 4, available: false, table: null },
      { date: "2026-05-24", time: "20:00", partySize: 2, available: true, table: "T1" },
      { date: "2026-05-25", time: "19:00", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-25", time: "20:00", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-26", time: "18:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-26", time: "19:30", partySize: 4, available: false, table: null },
      { date: "2026-05-26", time: "20:30", partySize: 6, available: true, table: "T9" },
      { date: "2026-05-27", time: "18:00", partySize: 2, available: true, table: "T3" },
      { date: "2026-05-27", time: "19:30", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-28", time: "19:00", partySize: 4, available: true, table: "T7" },
      { date: "2026-05-28", time: "20:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-29", time: "18:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-29", time: "19:30", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-29", time: "21:00", partySize: 6, available: false, table: null },
      { date: "2026-05-30", time: "12:30", partySize: 4, available: true, table: "T6" },
      { date: "2026-05-30", time: "18:30", partySize: 2, available: true, table: "T2" },
      { date: "2026-05-30", time: "19:30", partySize: 4, available: true, table: "T7" },
      { date: "2026-05-30", time: "20:30", partySize: 2, available: false, table: null }
    ],
    bookings: [
  ...
  edu_demo: {
    ...
    availability: [
      ...
      // Fresh test data — next ~7 days from 2026-05-23
      { date: "2026-05-23", time: "15:00", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-23", time: "17:30", service: "p3_english", available: false, teacher: null },
      { date: "2026-05-24", time: "11:00", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-24", time: "14:00", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-24", time: "16:00", service: "assessment", available: false, teacher: null },
      { date: "2026-05-25", time: "17:30", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-25", time: "18:30", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-26", time: "17:00", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-26", time: "18:30", service: "assessment", available: false, teacher: null },
      { date: "2026-05-27", time: "14:00", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-27", time: "17:30", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-28", time: "17:00", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-28", time: "18:30", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-29", time: "14:00", service: "assessment", available: true, teacher: "Mr Wong" },
      { date: "2026-05-29", time: "17:30", service: "assessment", available: false, teacher: null },
      { date: "2026-05-29", time: "18:30", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-30", time: "11:00", service: "p3_english", available: true, teacher: "Ms Chan" },
      { date: "2026-05-30", time: "14:00", service: "assessment", available: true, teacher: "Mr Wong" }
    ],
    bookings: [
