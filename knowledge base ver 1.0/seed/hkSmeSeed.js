...
module.exports = [
  ...
  },
  {
    ...
    tone: "mystic_practical",
    answers: {
      "zh-HK": "Solara Bazi 價目：NT$400 一個問題、NT$1,200 一個流年、NT$2,000 一個大運、NT$4,000 詳細批。",
      en: "Solara Bazi pricing: NT$400 for one question, NT$1,200 for annual luck reading, NT$2,000 for 10-year luck cycle reading, NT$4,000 for a detailed reading.",
      mixed: "Solara Bazi價目：NT$400一個問題、NT$1,200一個流年、NT$2,000一個大運、NT$4,000詳細批。"
    }
  },
  {
  ...
  },
  {
    ...
    safeAutoSend: true,
    answers: {
      "zh-HK": "可以使用轉帳、行動支付或信用卡付款，實際可用方式以商家設定為準。",
      en: "Payment can be made by bank transfer, mobile wallet, or card depending on the merchant settings.",
      mixed: "可以用轉帳、mobile wallet 或 card 付款，實際方式以商家設定為準。"
    }
  },
  {
